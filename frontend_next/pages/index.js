    ...
    <><>
      ...
      <div className="hidden absolute right-0 min-h-screen w-2/3 bg-primary py-4 px-8 shadow md:w-1/3">
        <button className="absolute top-0 right-0 mt-4 mr-4">
          ...
          <Image src="/icon-close.svg" className="h-10 w-auto" alt="icon-image" width='10' height='10'></Image>
        </button>
        ...
        <div className="container relative z-30 pt-20 pb-12 sm:pt-56 sm:pb-48 lg:pt-64 lg:pb-48">
          <div className="flex flex-col items-center justify-center lg:flex-row">
            <div className="rounded-full border-8 border-primary shadow-xl">
              ...
              {/* <Image src={builder.image(profile.image).width(200).url()} className="h-48 rounded-full sm:h-56" alt="author" width='200' height='48'></Image> */}

            

            {/* {profile.map((profile) => { 
              return <Image src={builder.image(profile.image).width(200).url()} 
              className="h-48 rounded-full sm:h-56" alt="author" width='200' height='48'></Image>
            ...
            <div className="pt-8 sm:pt-10 lg:pl-8 lg:pt-0">
              ...
              <div className="flex flex-col justify-center pt-3 sm:flex-row sm:pt-5 lg:justify-start">
                ...
                <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                  ...
                  <a href="https://www.linkedin.com/in/yash-bansod-99a792241/" className="pl-4">
          ...
          <div className="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
            ...
            <div className="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
              ...
              <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                ...
                {/* <a href="/" classNalme="p-4">
                  <i className="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i>
                </a> */}
                    <Link href="/" classNalme="p-4" >
              <i className="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i>
                   </Link>
                {/* <a href="/" className="pl-4">
                  <i className="bx bxl-dribbble text-2xl text-primary hover:text-yellow"></i>
                </a> */}
                <Link href="/" classNalme="p1-4">
                     <i className="bx bxl-dribbble text-2xl text-primary hover:text-yellow"></i> 
                </Link>
                {/* <a href="/" className="pl-4">
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                ...
                <Image src="/icon-development-white.svg" alt="development icon" fill></Image>
              </div>
              <div className="block group-hover:hidden">
                {/* <img src="/icon-development-black.svg" alt="development icon" /> */}
                <Image src="/icon-development-black.svg" alt="development icon" fill></Image>
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                ...
                <Image src="/icon-content-white.svg" alt="content marketing icon" fill ></Image>
            
              </div>
              <div className="block group-hover:hidden">
                {/* <img src="/assets/img/icon-content-black.svg" alt="content marketing icon" /> */}
                <Image src="/icon-content-black.svg" alt="content marketing icon" fill ></Image>
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                ...
                <Image src="/icon-mobile-white.svg" alt="Mobile Application icon" fill></Image>
              </div>
              <div className="block group-hover:hidden">
                {/* <img src="/assets/img/icon-mobile-black.svg" alt="Mobile Application icon" /> */}
                <Image src="/icon-mobile-black.svg" alt="Mobile Application icon" fill></Image>
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                ...
                <Image src="/icon-email-white.svg" alt="Email Marketing icon" fill></Image>
              </div>
              <div className="block group-hover:hidden">
                {/* <img src="/assets/img/icon-email-black.svg" alt="Email Marketing icon" /> */}
                <Image src="/icon-email-black.svg" alt="Email Marketing icon" fill></Image>
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                ...
                <Image src="/icon-design-white.svg" alt="Theme Design icon" fill></Image>

              </div>
              <div className="block group-hover:hidden">
                {/* <img src="/assets/img/icon-design-black.svg" alt="Theme Design icon" /> */}
                <Image src="/icon-design-black.svg" alt="Theme Design icon" fill></Image>
          ...
          <div className="group rounded px-8 py-12 shadow hover:bg-primary">
            <div className="mx-auto h-24 w-24 text-center xl:h-28 xl:w-28">
              <div className="hidden group-hover:block">
                ...
                <Image src="/icon-graphics-white.svg" alt="Graphic Design icon" fill ></Image>

              </div>
              <div className="block group-hover:hidden">
                {/* <img src="/assets/img/icon-graphics-black.svg" alt="Graphic Design icon" /> */}
                <Image src="/icon-graphics-black.svg" alt="Graphic Design icon" fill ></Image>
      ...
      <div className="container py-16 md:py-20" id="portfolio">
        ...
        <div className="mx-auto grid w-full grid-cols-1 gap-8 pt-12 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
          ...
          <Link href="/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <Image src="/portfolio-apple.jpeg" className="w-full shadow" alt="portfolio image" fill></Image>
          </Link>
          {/* <a href="/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <img src="/assets/img/portfolio-stripe.jpeg" className="w-full shadow" alt="portfolio image" />
          </a> */}
          <Link href="/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <Image src="/portfolio-stripe.jpeg" className="w-full shadow" alt="portfolio image" fill></Image>
          </Link>
          {/* <a href="/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <img src="/assets/img/portfolio-fedex.jpeg" className="w-full shadow" alt="portfolio image" />
          </a> */}
          <Link href="/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <Image src="/portfolio-fedex.jpeg"  className="w-full shadow" alt="portfolio image" fill></Image>
          </Link>
          {/* <a href="/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
            <img src="/assets/img/portfolio-microsoft.jpeg" className="w-full shadow" alt="portfolio image" />
          </a> */}
          <Link href="/" className="mx-auto transform transition-all hover:scale-105 md:mx-0">
                <Image src="/portfolio-microsoft.jpeg" className="w-full shadow" alt="portfolio image" fill></Image>
          </Link>
        </div>
      </div>
          ...
          <div className="mx-auto w-full sm:w-3/4 lg:w-full">
            ...
            <div className="flex flex-wrap items-center justify-center pt-4 sm:pt-4">
              <span className="m-8 block">
                ...
                <Image src="/logo-coca-cola.svg" alt="client logo" className="mx-auto block h-12 w-auto" fill></Image>
              </span>
              <span className="m-8 block">
                {/* <img src="/assets/img/logo-apple.svg" alt="client logo" className="mx-auto block h-12 w-auto" /> */}
                <Image src="/logo-apple.svg"  alt="client logo" className="mx-auto block h-12 w-auto" fill></Image>

              </span>

              <span className="m-8 block">
                {/* <img src="/assets/img/logo-netflix.svg" alt="client logo" className="mx-auto block h-12 w-auto" /> */}
                <Image src="/logo-netflix.svg" alt="client logo" className="mx-auto block h-12 w-auto" fill></Image>

              </span>

              <span className="m-8 block">
                {/* <img src="/assets/img/logo-amazon.svg" alt="client logo" className="mx-auto block h-12 w-auto" /> */}
                <Image src="/logo-amazon.svg" alt="client logo" className="mx-auto block h-12 w-auto" fill></Image>

              </span>

              <span className="m-8 block">
                {/* <img src="/assets/img/logo-stripe.svg" alt="client logo" className="mx-auto block h-12 w-auto" /> */}
                <Image src="/logo-stripe.svg" alt="client logo" className="mx-auto block h-12 w-auto" fill></Image>
            ...
            <div className="md:w-2/5">
              <div className="flex justify-center md:justify-start">
                <span className="shrink-0">
                  ...
                  <Image src="/logo-spotify.jpg" className="h-auto w-32" alt="company logo" fill></Image >
                </span>
            ...
            <div className="md:w-2/5">
              <div className="flex justify-center md:justify-start">
                <span className="shrink-0">
                  ...
                  <Image src="/logo-microsoft.svg" className="h-auto w-32" alt="company logo" fill></Image >
            ...
            <div className="md:w-2/5">
              <div className="flex justify-center md:justify-start">
                <span className="shrink-0">
                  ...
                  <Image src="/logo-fedex.svg" className="h-auto w-32" alt="company logo" fill></Image >
            ...
            <div className="grid grid-cols-2 gap-5 md:gap-8 xl:grid-cols-4 xl:gap-5">
              <div className="flex flex-col items-center justify-center text-center md:flex-row md:text-left">
                <div>
                  ...
                  <Image src="/icon-project.svg" className="mx-auto h-12 w-auto md:h-20" alt="icon project" fill></Image >
              ...
              <div className="flex flex-col items-center justify-center text-center md:flex-row md:text-left">
                <div>
                  ...
                  <Image src="/icon-award.svg" className="mx-auto h-12 w-auto md:h-20" alt="icon award"  fill></Image >
              ...
              <div
                ...
                <div>
                  {/* <img src="/assets/img/icon-happy.svg" className="mx-auto h-12 w-auto md:h-20"
                    ...
                    alt="icon happy clients" fill></Image>
                </div>
                <div className="pt-5 md:pl-5 md:pt-0">
                  <h1 className="font-body text-2xl font-bold text-primary md:text-4xl">
                    8
              ...
              <div
                ...
                <div>
                  ...
                  <Image src="/icon-puzzle.jpg" className="mx-auto h-12 w-auto md:h-20" alt="icon puzzle" fill></Image >
                </div>
                <div className="pt-5 md:pl-5 md:pt-0">
                  <h1 className="font-body text-2xl font-bold text-primary md:text-4xl">
                    0

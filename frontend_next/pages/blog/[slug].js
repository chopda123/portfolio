        ...
        <div class="mx-auto max-w-4xl">
          <div class="">
            ...
            <div class="flex items-center pt-5 md:pt-10">
              <div>
                {/* <img src={image.blogimage}
                  class="h-20 w-20 rounded-full border-2 border-grey-70 shadow"
                  alt="author image" /> */}
               
                <Image src="/bg-hero.jpg" width="20" height="20" alt="AuthorImage"
              ...
              <div class="pl-5">
                ...
                {/* {blogs.map((item) => { 
              return <Link key={item.author.current} href={"/blog/" + item.author.current} >
              <div>
              </div>
            </Link>
             })} */}
          ...
          <div class="mt-10 flex justify-between border-t border-lila py-12">
            ...
            <Link href="/" class="flex items-center">
              <a><i class="bx bx-left-arrow-alt text-2xl text-primary"></i>
              <span
                class="block pl-2 font-body text-lg font-bold uppercase text-primary md:pl-5">Previous
                Post</span></a>
            </Link>
            ...
            <Link href="/" class="flex items-center">
              <a><span class="block pr-2 font-body text-lg font-bold uppercase text-primary md:pr-5">Next
                Post</span>
              <i class="bx bx-right-arrow-alt text-2xl text-primary"></i></a>
            </Link>
          ...
          <div
            ...
            <div class="w-3/4 sm:w-2/5 lg:w-1/4 xl:w-1/5">
              ...
              <Image src="/blog-author" width="" height="" alt='author image' class="rounded-full shadow"> </Image>
            ...
            <div class="ml-0 text-center md:ml-10 md:w-5/6 md:text-left">
              ...
              <div class="flex items-center justify-center pt-5 md:justify-start">
                ...
                <Link href="/" class="flex items-center">
                <a><i class="bx bxl-facebook-square text-2xl text-primary hover:text-yellow"></i></a>
               </Link>
                {/* <a href="/" class="pl-4">
                  <i class="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i>
                </a> */}
                <Link href="/" class="flex items-center">
                <a><i class="bx bxl-twitter text-2xl text-primary hover:text-yellow"></i></a>
               </Link>
                {/* <a href="/" class="pl-4">
                  <i class="bx bxl-dribbble text-2xl text-primary hover:text-yellow"></i>
                </a> */}
                <Link href="/" class="flex items-center">
                <a><i class="bx bxl-dribbble text-2xl text-primary hover:text-yellow"></i></a>
               </Link>
                {/* <a href="/" class="pl-4">
                  <i class="bx bxl-linkedin text-2xl text-primary hover:text-yellow"></i>
                </a> */}
                <Link href="/" class="pl-4">
                <a><i class="bx bxl-linkedin text-2xl text-primary hover:text-yellow"></i></a>
               </Link>
                {/* <a href="/" class="pl-4">
                  <i class="bx bxl-instagram text-2xl text-primary hover:text-yellow"></i>
                </a> */}
                <Link href="/" class="pl-4">
                <a><i class="bx bxl-instagram text-2xl text-primary hover:text-yellow"></i></a>
               </Link>
              </div>
            </div>
          </div>
    ...
    <div class="bg-primary">
      <div class="container flex flex-col justify-between py-6 sm:flex-row">
        ...
        <div class="flex items-center justify-center pt-5 sm:justify-start sm:pt-0">
          ...
          <Link href="/" class="pl-4">
                <a><i class="bx bxl-facebook-square text-2xl text-white hover:text-yellow"></i></a>
          </Link>
          {/* <a href="/" class="pl-4">
            <i class="bx bxl-twitter text-2xl text-white hover:text-yellow"></i>
          </a> */}
          <Link href="/" class="pl-4">
                <a><i class="bx bxl-twitter text-2xl text-white hover:text-yellow"></i></a>
          </Link>
          {/* <a href="/" class="pl-4">
            <i class="bx bxl-dribbble text-2xl text-white hover:text-yellow"></i>
          </a> */}
          <Link href="/" class="pl-4">
                <a><i class="bx bxl-dribbble text-2xl text-white hover:text-yellow"></i></a>
          </Link>
          {/* <a href="/" class="pl-4">
            <i class="bx bxl-linkedin text-2xl text-white hover:text-yellow"></i>
          </a> */}
          <Link href="/" class="pl-4">
                <a><i class="bx bxl-linkedin text-2xl text-white hover:text-yellow"></i></a>
          </Link>
          {/* <a href="/" class="pl-4">
            <i class="bx bxl-instagram text-2xl text-white hover:text-yellow"></i>
          </a> */}
          <Link href="/" class="pl-4">
                <a><i class="bx bxl-instagram text-2xl text-white hover:text-yellow"></i></a>
          </Link>
        </div>
      </div>
    </div>
